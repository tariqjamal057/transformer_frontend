...
const NewGPSummary = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await api.get(`/mis-reports/new-gp-summary`);
      return res.data;
    },
  });
  ...
  return (
    <Container maxWidth="xl" sx={{ py: 4 }}>
      ...
      <NewGPSummaryFilter onFilteredData={setFilteredData} data={summaryData || []} />
      ...
      <Paper sx={{ p: 2, mt: 3 }}>
        ...
        <TableContainer sx={{ maxHeight: 520 }}>
          <Table stickyHeader size="small" aria-label="new-gp-summary-table">
            <TableHead>
              <TableRow>
